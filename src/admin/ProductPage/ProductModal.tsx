...
const selectClass =
  "w-full px-3 py-2 text-sm rounded-lg border border-gray-300 bg-white text-gray-800 focus:outline-none focus:border-gray-500 focus:ring-1 focus:ring-gray-300 transition-all";

const SectionCard = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 mb-5">
    <p className="text-[11px] font-bold uppercase tracking-widest text-gray-400 mb-5 pb-3 border-b border-gray-100">
      {title}
    </p>
    {children}
  </div>
...
export default function ProductForm() {
  ...
  const handleRemoveImage = (data: any) => {
    if (isEditMode) {
      ...
      setFieldValue("product_images", values.product_images.filter((item: any) => item._id !== data._id))
    } else {
      setFieldValue("product_images", values.product_images.filter((_: Base64URLString, i: number) => i !== data))
    }
  }
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          ...
          <SectionCard title="Basic Information">
            <div className="flex flex-col gap-1 mb-4">
              ...
              {touched.product_name && errors.product_name && (
                <p className="text-xs text-red-500 mt-0.5">{errors.product_name}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-1 mb-4">
              ...
              <input
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                placeholder="Short display title for storefront"
              />
              {touched.product_title && errors.product_title && (
                <p className="text-xs text-red-500 mt-0.5">{errors.product_title}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-1 mb-4">
              ...
              {touched.product_slug && errors.product_slug && (
                <p className="text-xs text-red-500 mt-0.5">{errors.product_slug}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              {touched.product_description && errors.product_description && (
                <p className="text-xs text-red-500 mt-0.5">{errors.product_description}</p>
              )}
            </div>
          </SectionCard>
          ...
          <SectionCard title="Product Images *">
            <label className="flex flex-col items-center justify-center gap-2 border-2 border-dashed border-gray-300 rounded-xl p-8 cursor-pointer hover:border-gray-400 hover:bg-gray-50 transition-all text-center">
              ...
              <input type="file" multiple accept="image/*" className="hidden" onChange={(e: React.ChangeEvent<HTMLInputElement>) => e.target.files && e.target.files.length > 0 && handleImage(e.target.files)} />
            </label>
            {touched.product_images && errors.product_images && typeof errors.product_images === "string" && (
              <p className="text-xs text-red-500 mt-2">{errors.product_images}</p>
            )}
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="flex flex-col gap-1">
                ...
                {touched.product_selling_price && errors.product_selling_price && (
                  <p className="text-xs text-red-500 mt-0.5">{errors.product_selling_price}</p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                {touched.product_mrp_price && errors.product_mrp_price && (
                  <p className="text-xs text-red-500 mt-0.5">{errors.product_mrp_price}</p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                {touched.product_discount && errors.product_discount && (
                  <p className="text-xs text-red-500 mt-0.5">{errors.product_discount}</p>
                )}
              </div>
            </div>
          </SectionCard>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                {touched.brand && errors.brand && (
                  <p className="text-xs text-red-500 mt-0.5">{errors.brand}</p>
                )}
              </div>
            </div>
          </SectionCard>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="flex flex-col gap-1">
                ...
                {touched.product_sku && errors.product_sku && (
                  <p className="text-xs text-red-500 mt-0.5">{errors.product_sku}</p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                {touched.product_stock && errors.product_stock && (
                  <p className="text-xs text-red-500 mt-0.5">{errors.product_stock}</p>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                {touched.low_stock_threshold && errors.low_stock_threshold && (
                  <p className="text-xs text-red-500 mt-0.5">{errors.low_stock_threshold}</p>
                )}
              </div>
            </div>
          </SectionCard>
          ...
          <SectionCard title="Tags & SEO">
              ...
              <div className="flex flex-wrap gap-1.5 px-3 py-2 border border-gray-300 bg-white rounded-lg min-h-[42px] cursor-text focus-within:border-gray-500 focus-within:ring-1 focus-within:ring-gray-300 transition-all">
                {values.product_tags.map((tag: string) => (
                  <span className="flex items-center gap-1 px-2.5 py-1 bg-gray-100 border border-gray-200 rounded-full text-xs text-gray-600 font-medium">
                    {tag}
                    <button onClick={() => setFieldValue("product_tags", values.product_tags.filter((t: string) => t !== tag))} type="button" className="text-gray-400 hover:text-gray-700 leading-none ml-0.5">×</button>
                  </span>
                ))}
                <input
                  className="bg-transparent outline-none text-sm text-gray-800 placeholder-gray-400 min-w-[80px] flex-1"
                  placeholder="Type and press Enter…"
                  onChange={handleProductTags}
                />
              </div>
              <span className="text-xs text-gray-400 mt-0.5">Press Enter or comma to add a tag</span>
              {touched.product_tags && errors.product_tags && typeof errors.product_tags === "string" && (
                <p className="text-xs text-red-500 mt-0.5">{errors.product_tags}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-1 mb-4">
              ...
              {touched.meta_title && errors.meta_title && (
                <p className="text-xs text-red-500 mt-0.5">{errors.meta_title}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-1 mb-4">
              ...
              {touched.meta_description && errors.meta_description && (
                <p className="text-xs text-red-500 mt-0.5">{errors.meta_description}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-wrap gap-1.5 px-3 py-2 border border-gray-300 bg-white rounded-lg min-h-[42px] cursor-text focus-within:border-gray-500 focus-within:ring-1 focus-within:ring-gray-300 transition-all">
                {values.meta_keywords.map((tag: string) => (
                  <span className="flex items-center gap-1 px-2.5 py-1 bg-gray-100 border border-gray-200 rounded-full text-xs text-gray-600 font-medium">
                    {tag}
                    <button onClick={() => setFieldValue("meta_keywords", values.meta_keywords.filter((t: string) => t !== tag))} type="button" className="text-gray-400 hover:text-gray-700 leading-none ml-0.5">×</button>
                  </span>
                ))}
                <input
                  className="bg-transparent outline-none text-sm text-gray-800 placeholder-gray-400 min-w-[80px] flex-1"
              ...
              {touched.meta_keywords && errors.meta_keywords && typeof errors.meta_keywords === "string" && (
                <p className="text-xs text-red-500 mt-0.5">{errors.meta_keywords}</p>
              )}
            </div>
          </SectionCard>
          ...
          <SectionCard title="Product Details (Key–Value)">
            {values?.product_details?.map((detail, index) => (
              <div key={index} className="grid grid-cols-[1fr_1fr_auto] gap-2 items-center mb-3">
                ...
                <button
                  onClick={() => setFieldValue("product_details", values.product_details.filter((_: Record<string, string>, i: number) => i !== index))}
                  type="button"
            ...
            {[
              ...
              >
                ...
                <div
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full border-2 cursor-pointer ${item.defaultOn
                    ? "bg-emerald-500 border-emerald-500"
                    : "bg-gray-200 border-gray-200"
                    }`}
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white shadow-sm transition-transform duration-200 ${item.defaultOn ? "translate-x-[22px]" : "translate-x-0.5"
                      }`}
                  />
                </div>
              </div>
          ...
          <div className="flex justify-end gap-3 mt-2 mb-10">
            <button
              type="button"
              className="px-5 py-2.5 text-sm rounded-lg border border-gray-300 text-gray-600 font-medium hover:bg-gray-50 transition-colors"
            >
              Reset
            </button>
            <button
              type="submit"
              className="px-7 py-2.5 text-sm rounded-lg bg-emerald-500 text-white font-semibold hover:bg-emerald-600 transition-colors shadow-sm"
            >
              Save product
            </button>
          </div>
