...
export default function BrandPage() {
  ...
  const [selectedBrand, setSelectedBrand] =
    useState<IBrandDocument | null>(null);
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          <div>
            ...
            <p className="text-gray-500 text-sm">
              Organize and manage your brands
            </p>
          </div>

          <button
            onClick={handleAdd}
            className="flex items-center justify-center gap-2 bg-indigo-600 text-white px-5 py-2 rounded-xl shadow hover:bg-indigo-700 transition"
          >
            <Plus size={18} />
            Add Brand
          </button>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 mt-10">
                {filteredBrands.map((brand) => (
                  <div
                    ...
                    className="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 p-5 flex flex-col"
                  >
                    <div className="flex justify-end gap-3 opacity-0 group-hover:opacity-100 transition duration-300 mb-4">
                      ...
                      <Trash2
                        size={18}
                        onClick={() =>
                          handleDelete(brand._id.toString())
                        }
                    ...
                    <div className="text-center space-y-2 mt-auto">
                      ...
                      <span
                        className={`inline-block px-3 py-1 text-xs rounded-full ${brand.authorized
