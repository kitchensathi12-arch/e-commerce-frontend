            ...
            <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl p-6 space-y-6 max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex justify-center">
                    {brand.brand_logo ? (
                        ...
                        <div className="w-24 h-24 bg-gray-100 flex items-center justify-center rounded-xl text-xs text-gray-400">
                            No Logo
                        </div>
                    )}
                </div>
                ...
                <div className="space-y-3 text-sm">
                    ...
                    <div>
                        ...
                        <span
                            className={`px-3 py-1 text-xs rounded-full ${brand.authorized
