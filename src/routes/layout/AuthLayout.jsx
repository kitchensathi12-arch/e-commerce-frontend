      ...
      >
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              Create your free account and unlock exclusive deals, order tracking, wishlists and
            ...
            <div className="grid grid-cols-2 gap-3">
              {FEATURES?.map(({ icon, label }) => (
                <div
                  key={label}
                  className="flex items-center gap-2 text-[13px] rounded-2xl px-4 py-3 transition-colors hover:bg-white/12"
                  style={{
