...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/Email-verified" element={isAuthenticated ? <VerifySuccess /> : <Navigate to="/login" replace />} />
      ...
      {/* Admin Routes */}
      <Route path="/" element={isAuthenticated && isAuthenticated?.role === 'admin' ? <AdminLayout /> : <Navigate to="/login" replace />}>
