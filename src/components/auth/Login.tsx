      ...
      <div className="relative w-full max-w-5xl overflow-hidden rounded-2xl shadow-2xl bg-white grid md:grid-cols-2">
        ...
        <div className="hidden md:flex flex-col justify-between px-12 py-10 bg-gradient-to-br from-sky-700 to-sky-900 text-white">
          <div>
            ...
            <p className="mt-3 text-sky-100 max-w-sm">Sign in to manage your orders, products and profile.</p>
          </div>

          <div className="flex flex-1 items-center justify-center">
            <img src="/login.png" alt="Login illustration" className="max-h-[400px] object-contain drop-shadow-2xl" />
          </div>
        ...
        <div className="bg-gray-100 p-8 sm:p-10">
          ...
          <form onSubmit={formik.handleSubmit} className="mt-8 space-y-5">
            ...
            <div>
              ...
              <button type="button" onClick={() => setShowPassword((p) => !p)} className="mt-1 text-xs font-medium text-sky-700 hover:underline">
                {showPassword ? 'Hide password' : 'Show password'}
              </button>
            </div>

            <div className="flex justify-end">
              <Link to="/forgot-password" className="text-sm font-medium text-sky-700 hover:underline">
                Forgot password?
              </Link>
            </div>
