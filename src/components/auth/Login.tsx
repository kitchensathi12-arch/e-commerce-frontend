        ...
        <div className="hidden md:flex flex-col justify-between px-10 py-10 text-white relative overflow-hidden" style={{ background: '#3b1f0e' }}>
          ...
          <div className="relative z-10">
            ...
            <p className="mt-3 text-sm leading-relaxed" style={{ color: '#c9b8a0' }}>
              Log in to make your orders,
              <br />
              products and profile and enhance your kitchen.
            </p>
          </div>
        ...
        <div className="p-8 sm:p-10" style={{ background: '#faf7f2' }}>
          ...
          <form onSubmit={formik.handleSubmit} className="mt-8 space-y-5">
            ...
            <div className="flex justify-end">
              <Link to="/forgot-password" className="text-sm font-medium hover:underline" style={{ color: '#e03e2d' }}>
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-6 text-center text-sm" style={{ color: '#8a7060' }}>
            ...
            <Link to="/register" className="font-medium hover:underline" style={{ color: '#e03e2d' }}>
              Create one
            </Link>
          </p>
        </div>
