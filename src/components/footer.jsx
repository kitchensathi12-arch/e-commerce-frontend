        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-10 mb-12">
          ...
          <div>
            ...
            {[
              ...
              <div key={i} className="flex gap-2.5 items-start mb-3 text-[14px] text-[#A0907A]">
            ...
            <div className="mt-5">
              <div className="text-[12px] text-[#A0907A] mb-2">We accept:</div>
        ...
        <div className="border-t border-white/10 pt-6 flex justify-between items-center flex-wrap gap-3">
          ...
          <div className="flex gap-5">
            {['Privacy Policy', 'Terms of Service', 'Refund Policy'].map((l) => (
              <span key={l} className="text-[12px] text-[#6B5B45] cursor-pointer">
                {l}
              </span>
            ))}
          </div>
