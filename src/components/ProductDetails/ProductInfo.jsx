  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div>
        ...
        <p className="text-[#6B5B45] text-sm mt-2 leading-relaxed">
      ...
      <div className="flex items-center gap-3 pb-4 border-b border-[#F0E8D4]">
        ...
        <span className="text-xs text-[#6B5B45]">(1000+ verified reviews)</span>
      ...
      <div className="bg-[#FFF4E0] rounded-2xl p-4 flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex flex-col items-end gap-1">
          ...
          <span className="text-xs text-green-700 font-semibold">
            You save ₹
            {((product?.product_mrp_price * product?.product_discount) / 100).toLocaleString()}
          </span>
        </div>
      </div>
