    ...
    <section className="w-full py-20 bg-white overflow-hidden">
      <div className="w-full px-6 lg:px-12">
        ...
        <div className="flex items-center justify-between mb-12">
          <div>
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-red-500 text-sm font-semibold tracking-widest uppercase">Our Products</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-semibold text-gray-900">Explore Our Products</h2>
          </div>
        ...
        <div className="flex justify-center mt-16">
          <button onClick={() => navigate('/all-products')} className="bg-red-500 hover:bg-red-600 text-white px-12 py-4 rounded-2xl font-medium flex items-center gap-3 transition-all">
            View All Products
            <ArrowRight size={20} />
          </button>
        </div>
