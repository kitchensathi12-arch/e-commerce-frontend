                ...
                <div className=" flex-around w-full max-w-screen px-6 h-16">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div className="text-[9px] text-text-muted tracking-[1.2px] font-medium uppercase">Your Trusted Kitchen Companion</div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button className="md:hidden cursor-pointer text-brown p-2 " onClick={() => setMobileOpen(!mobileOpen)}>
                ...
                {searchOpen && (
                    <div className="border-t border-amber-pale py-3 px-6 md:h-20 flex-center">
                        <div className="w-full md:w-150 mx-auto flex-center gap-2.5">
                            ...
                            <button
                                className=" bg-linear-to-br h-10 w-28  from-amber to-amber-light border-0 cursor-pointer text-white rounded-full flex-center gap-1.5 text-[13px] font-semibold"
                            >
                                Search
                            </button>
