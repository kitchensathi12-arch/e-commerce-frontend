    ...
    <div className="bg-white font-sans">
      ...
      <section className="relative bg-red-700 text-white py-24 px-6 text-center overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <p className="text-red-200 text-xs uppercase tracking-widest mb-3 font-medium">
            Power Tool & Kitchen Appliance Store
          </p>
          ...
          <p className="text-base md:text-lg text-red-100 max-w-2xl mx-auto leading-relaxed">
            High-quality tools, appliances, genuine spare parts, and reliable
            repair services — all under one roof.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
        ...
        <div>
          ...
          <p className="text-gray-500 leading-relaxed mb-4 text-sm">
            Welcome to our Power Tool & Kitchen Appliance Store — your
            one-stop destination for high-quality tools, appliances, and
            reliable repair services.
          </p>
          <p className="text-gray-500 leading-relaxed mb-4 text-sm">
            We specialize in offering a{" "}
            <span className="font-semibold text-gray-700">
              wide range of products
            </span>
            , including mixer grinders, hand tools, power tools, cutting
            machines, drilling machines, and genuine spare parts. Whether
            you're a DIY enthusiast, a professional technician, or simply
            looking for durable home appliances, we have everything you need.
          </p>
      ...
      <section className="bg-red-700 py-16 px-6">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-red-100 leading-relaxed text-base max-w-2xl mx-auto">
            ...
            , backed by excellent customer service. We understand how important
            your tools and appliances are in daily life, which is why we also
            offer{" "}
            <span className="text-white font-semibold">
              expert repair services
            </span>
            , especially for mixer grinders and other essential equipment.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Wide variety of trusted products — from power tools to kitchen
              appliances and genuine spare parts.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Authentic spare parts and accessories for all major brands,
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Affordable pricing with great deals — premium quality without
              breaking the bank.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Professional repair and maintenance services, especially for
              mixer grinders and essential equipment.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Quick and secure shipping across the country with real-time
              tracking and reliable support.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Dedicated customer support for a smooth and hassle-free
      ...
      <section className="bg-gray-50 py-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-white p-10 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <p className="text-gray-500 leading-relaxed text-sm">
              To provide top-quality tools and appliances at affordable prices,
              backed by expert repair services and excellent customer support
          ...
          <div className="bg-white p-10 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <p className="text-gray-500 leading-relaxed text-sm">
              To become the most trusted destination for power tools, kitchen
              appliances, and repair services — built on a foundation of
              quality, trust, and long-term customer relationships.
            </p>
          </div>
      ...
      <section className="py-20 px-6 text-center">
        ...
        <p className="text-gray-500 text-sm mb-8 max-w-md mx-auto">
          Explore our wide range of products or get in touch for expert repair
          services today.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to="/"
            className="inline-block bg-red-700 text-white px-10 py-3 rounded-full hover:bg-red-800 transition text-sm font-medium"
          >
            Shop Now
          </Link>
          <button
            onClick={() => navigate("/contact")}
            className="inline-block border border-red-700 text-red-700 px-10 py-3 rounded-full hover:bg-red-50 transition text-sm font-medium"
          >
            Contact Us
          </button>
        </div>
