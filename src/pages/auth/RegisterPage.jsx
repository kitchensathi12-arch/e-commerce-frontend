...
const RegisterPage = () => {
  ...
  return (
    <div className="bg-off-white flex flex-col justify-center px-6 py-8 sm:px-10 sm:py-10 lg:px-14 lg:py-10">
      ...
      <h2 className="font-playfair text-[26px] sm:text-[30px] font-bold text-text mb-1">
        Create Account
      </h2>
      <p className="text-text-muted text-[13px] sm:text-[13.5px] leading-relaxed mb-5">
        Start shopping the best kitchen essentials in India.
      </p>
      ...
      <div className="mb-5">
        <label className="flex items-start gap-2 cursor-pointer select-none">
          <input
            ...
            className="mt-0.5 w-[15px] h-[15px] accent-amber cursor-pointer flex-shrink-0"
          />
          <span className="text-[12.5px] text-text-muted leading-relaxed">
            I agree to the{' '}
            <a href="#" className="text-amber font-semibold hover:text-brown transition-colors">
              Terms of Service
            </a>{' '}
            and{' '}
            <a href="#" className="text-amber font-semibold hover:text-brown transition-colors">
      ...
      <div className="flex items-center gap-3 my-4 text-[11px] text-steel-dark font-medium uppercase tracking-wider">
        <span className="flex-1 h-px bg-border" /> or sign up with{' '}
