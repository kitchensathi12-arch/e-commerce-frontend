    ...
    <div style={{ fontFamily: "'Segoe UI', sans-serif", background: '#f1f3f6', minHeight: '100vh', padding: '24px 0' }}>
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '0 16px' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 2, padding: '32px 36px', boxShadow: '0 1px 2px rgba(0,0,0,0.08)' }}>
          <h1 style={{ fontSize: 24, fontWeight: 700, color: '#212121', marginBottom: 4, marginTop: 0 }}>Safe &amp; Secure Shopping</h1>
          ...
          <Section title="Is making an online payment secure on KitchenSathi?">
            <p>
              Yes, making online payments is completely secure on KitchenSathi. All transactions are processed over a 256-bit SSL encrypted connection, ensuring your payment details are fully
              protected. We are PCI-DSS compliant, which means we meet the highest industry standards for handling cardholder information.
            </p>
          ...
          <Section title="Does KitchenSathi store my credit/debit card information?">
            <p>
              No. KitchenSathi only stores the <strong>last 4 digits</strong> of your card number for the purpose of card identification. Your full card number, CVV, and expiry date are never stored
              on our servers. All payment data is handled directly by our PCI-DSS certified payment gateway partners.
            </p>
          </Section>
          ...
          <Section title="Do you accept payment made by credit/debit cards issued in other countries?">
            ...
            <div style={{ background: '#f7f9fc', border: '1px solid #e0e0e0', borderRadius: 4, padding: '14px 18px', margin: '12px 0', fontSize: 13, color: '#4a4a4a', lineHeight: 1.9 }}>
              Australia, Austria, Belgium, Canada, Cyprus, Denmark, Finland, France, Germany, Ireland, Italy, Luxembourg, the Netherlands, New Zealand, Norway, Portugal, Singapore, Spain, Sweden, the
          ...
          <Section title="What should I do if I suspect unauthorized activity on my account?">
            ...
            />
            <Callout type="info">
              <strong>Tip:</strong> KitchenSathi will <strong>never</strong> ask you to share your OTP, full card number, CVV, or net banking credentials over a call or email. Any such request is a
              fraud attempt — please report it immediately.
            </Callout>
          </Section>
          ...
          <Section title="Privacy Policy">
            <p>
              KitchenSathi respects your privacy and is committed to protecting it. For complete details on how we collect, use, and protect your personal information, please refer to our{' '}
              <a href="/privacy-policy" style={{ color: '#2874f0', textDecoration: 'none', fontWeight: 600 }}>
                Privacy Policy
              </a>
              .
            </p>
          ...
          <Section title="Contact Us">
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginTop: 8 }}>
              ...
              <LinkButton href="tel:044-45614700" secondary>
                044-45614700
              </LinkButton>
            </div>
          </Section>
