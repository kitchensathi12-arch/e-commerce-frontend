    ...
    <div style={{ fontFamily: "'Segoe UI', sans-serif", background: '#f1f3f6', minHeight: '100vh', padding: '24px 0' }}>
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '0 16px' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 2, padding: '32px 36px', boxShadow: '0 1px 2px rgba(0,0,0,0.08)' }}>
          <h1 style={{ fontSize: 24, fontWeight: 700, color: '#212121', marginBottom: 4, marginTop: 0 }}>Order Cancellation and Return Policy</h1>
          ...
          <Section title="Cancellation Policy">
            <p>
              The customer can choose to cancel an order any time before it is dispatched. The order cannot be cancelled once it is out for delivery. However, the customer may choose to reject it at
              the doorstep.
            </p>
            <p>
              The time window for cancellation varies based on different categories, and the order cannot be cancelled once the specified time has passed. In some cases, a cancellation fee will be
              charged post the specified time. The details mentioned on the product page or order confirmation page will be considered final.
            </p>
            ...
            <Callout type="info">
              <strong>Hyperlocal / MINUTES Delivery:</strong> Orders placed under the MINUTES delivery option are non-cancellable and non-refundable via self-serve, owing to quick delivery times,
              except when cancellation/refund is requested via a Customer Support Agent under these specific circumstances:
          ...
          <Section title="Returns Policy">
            <p>
              Returns is a scheme provided by respective Sellers directly under this policy, in terms of which the option of exchange, replacement, and/or refund is offered by the respective Sellers
              to you. All products listed under a particular category may not have the same returns policy. For all products, the returns/replacement policy provided on the product page shall prevail
              over the general returns policy.
            </p>
          ...
          <Section title="Part 2 – Returns Pick-Up and Processing">
            <p>
              In case of returns where you would like item(s) to be picked up from a different address, the address can only be changed if pick-up service is available at the new address. During
              pick-up, your product will be checked for the following conditions:
            </p>
            ...
            <Callout type="warning">
              The field executive will refuse to accept the return if any of the above conditions are not met. For any products for which a refund is to be given, the refund will be processed once the
          ...
          <Section title="Refund Policy">
            ...
            />
            <Callout type="info">
              <strong>Refund Timeline:</strong> Refund will be processed within <strong>5–7 business days</strong> from the date the refund is initiated. You can track the status of your refund on the
              Order Details page.
            </Callout>
          </Section>
...
const pickupConditions: [string, string][] = [
  ...
  [
    'Unused Product',
    'The product should be unused, unwashed, unsoiled, without stains, and with non-tampered quality check seals/return tags/warranty seals. Mobile/Laptop/Tablet must be factory reset; iCloud lock disabled for Apple devices.',
  ],
