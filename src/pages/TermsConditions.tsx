    ...
    <div style={{ fontFamily: "'Segoe UI', sans-serif", background: '#f1f3f6', minHeight: '100vh', padding: '24px 0' }}>
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '0 16px' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 2, padding: '32px 36px', boxShadow: '0 1px 2px rgba(0,0,0,0.08)' }}>
          <h1 style={{ fontSize: 24, fontWeight: 700, color: '#212121', marginBottom: 4, marginTop: 0 }}>KitchenSathi Terms of Use</h1>
          ...
          <p style={{ fontSize: 14, color: '#4a4a4a', lineHeight: 1.9, marginBottom: 20 }}>
            This document is an electronic record in terms of the Information Technology Act, 2000. By accessing, browsing, or using the KitchenSathi Platform (website, mobile site, or mobile
            application), you agree to all the terms and conditions under these Terms of Use. Please read carefully before proceeding.
          </p>
          <p style={{ fontSize: 14, color: '#4a4a4a', lineHeight: 1.9, marginBottom: 28 }}>
            The Platform is owned and operated by <strong>KitchenSathi Private Limited</strong>, a company incorporated under the Companies Act. "You" or "User" refers to any person who accesses or
          ...
          <Section title="3. Consent to Advertisements">
            <p>
              By accessing or using the Platform, you grant express consent for KitchenSathi to display advertisements, promotions, and sponsored content. These may be placed adjacent to, integrated
          ...
          <Section title="7. Contents Posted on Platform">
            <p>
              All text, graphics, photographs, trademarks, logos, and artwork ("Content") that is user-generated remains the responsibility of the user who posted it. KitchenSathi acts as an
              intermediary and does not exercise editorial control over third-party user-generated content.
            </p>
            <p>
              You grant KitchenSathi a non-exclusive, worldwide, perpetual, royalty-free right to use Content you post, consistent with our Privacy Policy, for any purpose including promotional and
          ...
          <Section title="8. Disclaimer of Warranties and Liability">
            <p>
              The Platform, all materials, products, and services are provided on an "as is" and "as available" basis without any representation or warranties, express or implied. KitchenSathi does
              not warrant that:
            </p>
            <BulletList
              items={[
            ...
            <Callout type="warning">
              IN NO EVENT SHALL KITCHENSATHI BE LIABLE FOR ANY SPECIAL, INCIDENTAL, INDIRECT, OR CONSEQUENTIAL DAMAGES OF ANY KIND IN CONNECTION WITH THESE TERMS OF USE, EVEN IF INFORMED IN ADVANCE OF
          ...
          <Section title="9. Indemnity">
            <p>
              You shall indemnify and hold harmless KitchenSathi, its owners, licensees, affiliates, subsidiaries, group companies, and their respective officers, directors, agents, and employees from
          ...
          <Section title="10. Applicable Law and Jurisdiction">
            <p>
              These Terms of Use shall be governed by and construed in accordance with the laws of India. The place of jurisdiction shall be exclusively in <strong>Bengaluru, Karnataka</strong>.
            </p>
          </Section>
...
function ContactBox({ name, title, address, email, phone, hours }: { name: string; title: string; address: string; email: string; phone: string; hours: string }) {
  return (
