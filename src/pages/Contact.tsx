    ...
    <div className="bg-white font-sans">
      ...
      <section className="relative bg-red-700 text-white py-16 px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-red-100 text-sm max-w-md mx-auto leading-relaxed">We aree here to help. Reach out to us anytime and we'll get back to you as soon as possible.</p>
        </div>
      </section>
