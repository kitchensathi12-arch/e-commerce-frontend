          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-7 shadow-sm">
              ...
              <p className="text-gray-700 text-sm mb-1">
                Emails:{" "}
                <span className="font-medium">customer@exclusive.com</span>
              </p>
          ...
          <div className="md:col-span-2">
            <form onSubmit={handleSubmit} className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm space-y-5">
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  className="bg-red-600 hover:bg-red-700 text-white text-sm font-medium px-10 py-3 rounded-lg transition"
                >
                  Send Message
                </button>
              </div>
