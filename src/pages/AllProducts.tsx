...
const MOCK_PRODUCTS = [
  { id: "1", name: "Noise Airwave Max 4", price: 1699, mrp: 5999, category: "audio", brand: "noise", stock: 10, rating: 4.5, reviews: 128, image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=300&h=300&fit=crop", badge: "Best Seller" },
  { id: "2", name: "Phillips Air Fryer XL", price: 6499, mrp: 9999, category: "kitchen", brand: "phillips", stock: 5, rating: 4.3, reviews: 89, image: "https://images.unsplash.com/photo-1585515320310-259814833e62?w=300&h=300&fit=crop", badge: "Hot" },
  { id: "3", name: "Samsung Galaxy Buds 2", price: 3999, mrp: 7999, category: "electronics", brand: "samsung", stock: 20, rating: 4.6, reviews: 245, image: "https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=300&h=300&fit=crop", badge: "New" },
  { id: "4", name: "Nike Pro Training Shorts", price: 1299, mrp: 2499, category: "fitness", brand: "nike", stock: 15, rating: 4.2, reviews: 67, image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=300&h=300&fit=crop", badge: "" },
  { id: "5", name: "Phillips Smart LED TV 43\"", price: 28999, mrp: 42000, category: "electronics", brand: "phillips", stock: 3, rating: 4.7, reviews: 312, image: "https://images.unsplash.com/photo-1593784991095-a205069470b6?w=300&h=300&fit=crop", badge: "Sale" },
  { id: "6", name: "Bosch Hand Blender", price: 2199, mrp: 3500, category: "kitchen", brand: "bosch", stock: 8, rating: 4.1, reviews: 43, image: "https://images.unsplash.com/photo-1570222094114-d054a817e56b?w=300&h=300&fit=crop", badge: "" },
  { id: "7", name: "Nike Air Max 270", price: 7999, mrp: 12000, category: "fitness", brand: "nike", stock: 12, rating: 4.8, reviews: 521, image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=300&h=300&fit=crop", badge: "Trending" },
  { id: "8", name: "Samsung 65W Charger", price: 1499, mrp: 2999, category: "electronics", brand: "samsung", stock: 25, rating: 4.0, reviews: 88, image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=300&fit=crop", badge: "" },
  { id: "9", name: "Noise ColorFit Ultra", price: 2999, mrp: 5999, category: "fitness", brand: "noise", stock: 18, rating: 4.4, reviews: 176, image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=300&h=300&fit=crop", badge: "New" },
  { id: "10", name: "Phillips Mixer Grinder", price: 3499, mrp: 5500, category: "kitchen", brand: "phillips", stock: 7, rating: 4.3, reviews: 95, image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=300&h=300&fit=crop", badge: "" },
  { id: "11", name: "Bosch Cordless Drill", price: 5999, mrp: 8999, category: "electronics", brand: "bosch", stock: 6, rating: 4.5, reviews: 134, image: "https://images.unsplash.com/photo-1504148455328-c376907d081c?w=300&h=300&fit=crop", badge: "" },
  { id: "12", name: "Samsung QLED 55\"", price: 52999, mrp: 75000, category: "electronics", brand: "samsung", stock: 2, rating: 4.9, reviews: 423, image: "https://images.unsplash.com/photo-1593784991095-a205069470b6?w=300&h=300&fit=crop", badge: "Premium" },
];
    ...
    return (
      <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden flex gap-4 p-4 hover:border-red-200 hover:shadow-md transition-all group">
        <div className="relative w-28 h-28 flex-shrink-0 rounded-xl overflow-hidden bg-gray-50">
          ...
          {product.badge && (
            <span className={`absolute top-1.5 left-1.5 text-[10px] font-semibold px-1.5 py-0.5 rounded-md ${badgeColors[product.badge] || "bg-gray-100 text-gray-600"}`}>
              {product.badge}
            </span>
          )}
        </div>
        ...
        <div className="flex-shrink-0 flex items-center">
          <button className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm rounded-xl transition-colors">
            View
          </button>
        </div>
      </div>
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden flex flex-col hover:border-red-200 hover:shadow-md transition-all group">
      <div className="relative h-48 overflow-hidden bg-gray-50">
        <img src={product.image} alt={product.name} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
        {product.badge && (
          <span className={`absolute top-3 left-3 text-[10px] font-semibold px-2 py-1 rounded-lg ${badgeColors[product.badge] || "bg-gray-100 text-gray-600"}`}>
            {product.badge}
          </span>
        )}
        <span className="absolute top-3 right-3 bg-white text-green-600 text-[10px] font-bold px-2 py-1 rounded-lg">
          {discount}% OFF
        </span>
      </div>
      <div className="p-4 flex-1 flex flex-col">
        ...
        <button className="mt-3 w-full py-2 bg-red-500 hover:bg-red-600 text-white text-sm rounded-xl transition-colors">
          View Details
        </button>
      </div>
    </div>
  ...
  const Sidebar = () => (
    <div className="w-full">
      ...
      <SidebarSection
        ...
        onSelect={(id) => { setSelectedBrand(id); setSidebarOpen(false); }}
      />
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden bg-white">
                <button
                  ...
                  className={`p-2.5 transition ${view === "grid" ? "bg-red-600 text-white" : "text-gray-500 hover:bg-gray-50"}`}
                >
                  <Grid3X3 size={15} />
                </button>
                <button
                  onClick={() => setView("list")}
                  className={`p-2.5 transition ${view === "list" ? "bg-red-600 text-white" : "text-gray-500 hover:bg-gray-50"}`}
                >
                  <List size={15} />
                </button>
              </div>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              {(priceRange[0] > 0 || priceRange[1] < 80000) && (
                <span className="flex items-center gap-1 text-xs bg-red-50 text-red-700 px-3 py-1 rounded-full border border-red-200">
                  ...
                  <button onClick={() => setPriceRange([0, 80000])}><X size={11} /></button>
                </span>
              )}
            </div>
          )}
